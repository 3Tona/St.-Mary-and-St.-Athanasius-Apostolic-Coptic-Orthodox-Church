...
// التعديل الأساسي للـ Public: السيرفر السحابي يحدد الـ Port ديناميكياً، وإلا يعمل على 3000 محلياً
...
// الحجز المشروط بحجز واحد نشط فقط في النظام ككل و بحد أقصى 40 يوم
app.post('/api/appointments/book', (req, res) => {
    ...
    // التحقق من وجود أي حجز نشط للمستخدم في النظام بالكامل
...
// 7. إدارة الحسابات للأدمن (حظر، فك حظر، حذف)
